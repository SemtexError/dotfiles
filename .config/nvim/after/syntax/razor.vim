...
"razor
syn cluster rBlocks add=rCodeBlock,rCodeLine,rComment,rInherits,rUsing,rModel
...
syn region rModel start="^@model " end="$" containedin=ALLBUT,@rBlocks
syn match rNamespace "\s\+\w\+\(\.\w\+\)*" containedin=rUsing,rModel contained
