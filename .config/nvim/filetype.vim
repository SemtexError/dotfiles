...
autocmd BufNewFile,BufRead *.exclude :set filetype=aspvbs
...
autocmd BufNewFile,BufRead *.jpg :set filetype=image
autocmd BufNewFile,BufRead *.jepg :set filetype=image
autocmd BufNewFile,BufRead *.giv :set filetype=image
