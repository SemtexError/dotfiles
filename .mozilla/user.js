...
// Let cookie auto delete clear cookies
...
// Disable open new window when clicking middle mouse
user_pref("middlemouse.openNewWindow", false);

// Disable warnings
user_pref("browser.tabs.warnOnClose", false);

// Set home tab en new tab to search bar
user_pref("browser.startup.homepage", "about:home");
user_pref("browser.newtab.url", "about:home");
user_pref("browser.newtabpage.enabled", true);
user_pref("browser.startup.page", 1);
// Hide top sites from home/new tab
...
// Enable fingerprint protection and fingerprint reistance
...
// Enable user content css
user_pref("toolkit.legacyUserProfileCustomizations.stylesheets", true);

// Load boomarks in current tab
user_pref("browser.tabs.loadBookmarksInTabs", false);

// ctrl+tab scroll through tabs
user_pref("browser.ctrlTab.recentlyUsedOrder", false);

// Close Firefox when last tab is closed
user_pref("browser.tabs.closeWindowWithLastTab", true);

// Open menu with mouse up, prevent double clicks
...
// Do not search when tying
user_pref("accessibility.typeaheadfind", false);

// Check spelling when I type
